<template>
    <div class="page-container text-center text-light">
        ...
        <ul>
            <li>
                Youtubeが提供する機能の無料分でできる範囲でのご利用となります。
            </li>
            <li>
                Youtube外部プレイヤーを使用しています。クリップ作成時に広告が流れる場合があります。
            </li>
        </ul>
        <div class="menu-grid text-wrap">
            ...
            <div class="menu-item" @click="goToPage('/user/video')">
                <div class="fs-3">保存したクリップ</div>
                <p class="fs-6 text-body-tertiary">
                    保存したクリップなどを確認します
                </p>
            </div>
